// Check if the top bar slider exists and initialize Swiper
...
// Initialize the main slideshow slider
if ($(".tf-sw-slideshow").length > 0) {
  ...
  var delay = $(".tf-sw-slideshow").data("delay"); // Should be 9000 for 9 seconds
  var speed = $(".tf-sw-slideshow").data("speed"); // e.g., 1500 for 1.5 seconds
  var centered = $(".tf-sw-slideshow").data("centered");

  var swiper = new Swiper(".tf-sw-slideshow", {
    autoplay: {
      delay: delay, // 4000 milliseconds = 9 seconds
      disableOnInteraction: false,
      pauseOnMouseEnter: true,
    },
...
// Initialize sliders with effect "fade"
if ($(".tf-sw-effect").length > 0) {
  var swiper2 = new Swiper(".tf-sw-effect", {
    spaceBetween: 0,
    // autoplay is commented out
    // autoplay: {
    //   delay: 2000,
    //   disableOnInteraction: false,
    // },
...
// Initialize thumbnails for default gallery
...
// Initialize thumbnails for black gallery
...
// Initialize thumbnails for blue gallery
...
// Initialize thumbnails for white gallery
...
// Initialize the lookbook slider
...
// Initialize the lookbook main slider
...
if ($(".tf-sw-brand").length > 0) {
  ...
  var play = $(".tf-sw-brand").data("play"); // Assuming boolean
  ...
  var swiper = new Swiper(".tf-sw-brand", {
    ...
    loop: loop,
    // Removed redundant autoplay: play
    observer: true,
    observeParents: true,
    slidesPerGroup: 2,
    navigation: {
...
// Initialize the shop gallery slider
...
// Initialize mobile slider (responsive)
...
// Initialize another mobile slider (responsive)
...
// Initialize the product sell slider 1
...
// Initialize the product sell slider
...
// Initialize the single slide slider
...
// Initialize the testimonial thumbnails slider
...
// Initialize the cart slide slider
...
// Initialize the product header slider
